...
playerTurn = "x"; // Current player's turn ("x" or "o")
moves = 0; // Number of moves played
isGameOver = false; // Flag indicating whether the game is over
span = document.getElementsByTagName("span"); // Get all <span> elements
...
// Check for a winner with given cell indices
